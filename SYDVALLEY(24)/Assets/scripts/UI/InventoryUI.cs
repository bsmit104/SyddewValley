...
public class InventoryUI : MonoBehaviour
{
    ...
    [SerializeField] private Color sellableSelectedColor = new Color(0.5f, 0.9f, 0.5f, 1f);
    [SerializeField] private Color sellableHoverColor = new Color(0.6f, 0.9f, 0.6f, 1f);
    ...
    {
        // Re-initialize UI elements after scene load
    ...
    private System.Collections.IEnumerator ReinitializeAfterSceneLoad()
    {
        ...
        // Find the inventory reference if it was lost
        if (inventory == null)
        {
        ...
        if (hasItem)
        {
            ...
            if (isSellable)
            {
                if (isSelected && isHovered) {
                    slotColor = sellableSelectedColor;
                }
                else if (isSelected) {
                    slotColor = sellableSelectedColor;
                }
                else if (isHovered) {
                    slotColor = sellableHoverColor;
                }
                else {
                    slotColor = sellableColor;
                }
            }
            else
            {
    ...
    void Update()
    {
        if (isInShopRange && Input.GetMouseButtonDown(1))
        {
