...
public class NPCInteraction : MonoBehaviour
{
    ...
    public void GiveGift(Item gift)
    {
        ...
        // FIRST: Check if this NPC has an active quest and if the item is the quest item
        if (QuestManager.Instance != null)
        {
            ...
            {
                // This is a quest item! Complete the quest (bypass gift limits)
                CompleteQuest(activeQuest, gift);
                return;
            }
        }

        // SECOND: Check if NPC can receive another gift today (only for regular gifts)
